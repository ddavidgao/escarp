...
def _human_readable(slot: dict, verify: dict) -> str:
    ...
    lines = [
        ...
        f"  cua_app:           {slot.get('cua_app_bundle_id') or '(not configured)'}",
        f"  bounds:            {bounds_str}",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.as_json:
        out = {
            ...
            "cua_app_bundle_id": slot.get("cua_app_bundle_id"),
            "cua_app_name": slot.get("cua_app_name"),
            "cua_app_path": slot.get("cua_app_path"),
